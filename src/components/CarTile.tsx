...
import { Column, ColumnContainer, Container, RowContainer } from '../styled-components/Layout';
    ...
    return (
        <Box>
            <Container padding={"20px"}>
                <BackgroundImageSvg url={pictureUrl} />
                <ColumnContainer>
                ...
                {listIds?.findIndex((x: number) => x === car.stockNumber) === -1 ? <BsBookmarkX /> : <BsBookmarkCheck color={Colors.primaryColor} />}
            </Container>
        </Box>
    )
}
